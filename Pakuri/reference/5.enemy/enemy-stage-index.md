...
> 목적: 각 스테이지에서 등장하는 일반 적, 5일차 중간보스, 10일차 중간보스, 보스의 설계 위치를 정리한다.
...
|  스테이지 | 일반 적 방향         | 5일차 중간보스 | 10일차 중간보스 | 보스        |
| ----: | --------------- | -------- | --------- | --------- |
| 1스테이지 | 용사길드, 기본 직업군 학습 | 검호 레온   | 기사단장 브란   | 용사 카린    |
| 2스테이지 | 용살자, 관통과 강타     | 성창추적자 에단  | 용살기사 드레이크     | 용살자 아르센 |
| 3스테이지 | 환영, 분신과 타겟 교란   | 환술사 로키     | 예언자 모르간    | 사도 라키아 |
| 4스테이지 | 천상, 신성 심판과 보호막  | 집행관 미카엘   | 대행자 토르   | 심판자 세라프   |

## 3. 문서 분리 기준
스테이지별 적 목록이 구체화되면 아래처럼 분리한다.

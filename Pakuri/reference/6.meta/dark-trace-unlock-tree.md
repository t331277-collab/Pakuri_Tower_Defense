...
| 3 | 캐릭터 액티브 콘텐츠 해금 | 캐릭터별 액티브 스킬 성장 화면을 연다. |
| 4 | 액티브 강화 선택폭 증가 | 액티브 성장 시 선택 가능한 강화 방향이 늘어난다. |
| 5 | 캐릭터 전용 시작 보너스 | 특정 캐릭터를 선택하고 런을 시작할 때 작은 전투 보너스를 받는다. |
| 6 | 캐릭터 숙련 보상 | 같은 캐릭터로 여러 번 런을 진행하면 추가 성장 보상을 받을 수 있다. |

...
namespace Pakuri.InGame
{
    internal interface ISkillCastCondition
    {
         ...
         * 거부를 실행해야 하는지 확인한다.
         */
        bool ShouldReject(SkillExecutionContext context, SkillExecutionSnapshot snapshot, SingleSkillRuntimeData skill);
    }
    ...
    internal interface ISkillDamageModifier
    {
         ...
         */
        void Apply(SingleSkillRuntimeData skill, SkillExecutionSnapshot snapshot, BaseUnitRuntimeModel target, ref SingleDamageModifierState state);
    }
    ...
    internal interface ISkillPostHitAction
    {
         ...
         * 적중 결과에 후속 행동을 적용한다.
         */
        bool TryApply(SkillRuntimeInstance sourceRuntime, SingleSkillRuntimeData skill, SkillExecutionSnapshot snapshot, InGameResourceChangeResult result, bool wasExecute);
    }
     ...
     */
    internal static class SingleSkillRuleHandlers
    {
         ...
         * 피해 보정값을 적용한다.
         */
        public static SingleDamageModifierState ApplyDamageModifiers(
            SingleSkillRuntimeData skill,
            SkillExecutionSnapshot snapshot,
    ...
    internal sealed class TargetHealthRatioCastCondition : ISkillCastCondition
    {
         ...
         * 거부를 실행해야 하는지 확인한다.
         */
        public bool ShouldReject(SkillExecutionContext context, SkillExecutionSnapshot snapshot, SingleSkillRuntimeData skill)
        {
            if (context == null
                || skill == null
         ...
         */
        public static bool TryResolveThreshold(SingleSkillRuntimeData skill, SkillExecutionSnapshot snapshot, out float threshold)
        {
            var bonus = 0f;
    ...
    internal sealed class ExecuteDamageModifier : ISkillDamageModifier
    {
         ...
         */
        public void Apply(SingleSkillRuntimeData skill, SkillExecutionSnapshot snapshot, BaseUnitRuntimeModel target, ref SingleDamageModifierState state)
        {
            if (skill == null
                || target == null
    ...
    internal sealed class KillCooldownResetAction : ISkillPostHitAction
    {
         ...
         */
        public bool TryApply(SkillRuntimeInstance sourceRuntime, SingleSkillRuntimeData skill, SkillExecutionSnapshot snapshot, InGameResourceChangeResult result, bool wasExecute)
        {

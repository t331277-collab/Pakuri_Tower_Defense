...
namespace Pakuri.InGame
{
    ...
    public sealed class LineSkillExecutor : TypedSkillExecutor<LineSkillRuntimeData>
    {
        ...
        {
            var skill = context != null ? context.SkillRuntimeData as LineSkillRuntimeData : null;
         ...
         * 지속시간을 결정한다.
         */
        private static float ResolveDuration(LineSkillRuntimeData skill, SkillExecutionSnapshot snapshot)
        {
         ...
         * Line 너비를 결정한다.
         */
        private static float ResolveLineWidth(LineSkillRuntimeData skill, SkillExecutionSnapshot snapshot)
        {
         ...
         * 밀쳐내기 거리를 결정한다.
         */
        private static float ResolveKnockbackDistance(LineSkillRuntimeData skill, SkillExecutionSnapshot snapshot)
        {
         ...
         */
        private static float ResolveLineVisualWidthScale(SkillExecutionSnapshot snapshot)
        {
         ...
         * 주기 간격을 결정한다.
         */
        private static float ResolveTickInterval(LineSkillRuntimeData skill, SkillExecutionSnapshot snapshot)
        {

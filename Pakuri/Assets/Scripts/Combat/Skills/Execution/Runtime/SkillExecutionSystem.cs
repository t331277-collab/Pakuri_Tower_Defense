...
namespace Pakuri.InGame
{
    ...
    internal sealed class SkillExecutorRegistry
    {
        ...
        private void RegisterDefaults()
        {
            ...
            Register(new LineSkillExecutor());
            Register(new SingleSkillExecutor());
            Register(new ZoneSkillExecutor());
            Register(new BuffSkillExecutor());
            Register(new BuffShieldSkillExecutor());
            Register(new BuffHealSkillExecutor());
            Register(new SingleChainSkillExecutor());
            Register(new SingleChargeSkillExecutor());
        }
    }

...
namespace Pakuri.NewCore.Definitions.Choices
{
    public class ChoiceNodeDefinition : CsvDefinition
    {
        ...
        public string owner_kind => OptionalString(nameof(owner_kind));

        public string owner_id => OptionalString(nameof(owner_id));

        public string graph_kind => OptionalString(nameof(graph_kind));

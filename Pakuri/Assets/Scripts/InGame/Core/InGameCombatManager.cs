...
namespace Pakuri.InGame
{
    ...
    public class InGameCombatManager : MonoBehaviour
    {
        ...
        private readonly InGamePassiveEffectRuntime passiveEffects = new InGamePassiveEffectRuntime();
        ...
        internal InGamePassiveEffectRuntime PassiveEffects => passiveEffects;
        ...
        private void Awake()
        {
            enemyController = new EnemyController(roster, skillExecution, this);
            roster.Clear();
        ...
        public UnitRosterEntry RegisterPlayerMonster(MonsterUnitRuntimeModel model, MonsterUnitActor actor, Transform hitboxRoot)
        {
            ...
            if (PlayerCombatControl.IsSelectedPlayerModel(model))
            {

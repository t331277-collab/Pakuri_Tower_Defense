...
namespace Pakuri.Data
{
    ...
    public static partial class PakuriCsvRuntimeData
    {
        ...
        private sealed class SourceModel
        {
            ...
            public readonly Dictionary<string, EnemyMigrationRow> Enemies = new Dictionary<string, EnemyMigrationRow>(StringComparer.OrdinalIgnoreCase);

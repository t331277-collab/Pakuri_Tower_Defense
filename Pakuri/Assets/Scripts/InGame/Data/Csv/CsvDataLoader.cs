...
namespace Pakuri.Data
{
    ...
    public static partial class CsvDataLoader
    {
        ...
        private const string RuntimeCatalogAssetPath = RuntimeResourcesFolderAssetPath + "/CsvRuntimeCatalog.asset";
        private const string RuntimeCatalogResourcesPath = "Pakuri/CSVRuntime/CsvRuntimeCatalog";
        ...
        private static CsvRuntimeCatalog runtimeCsvCatalog;
        ...
        public static void EnsureInitialized()
        {
            ...
            {
                FailAndQuit(
                    "CsvDataLoader failed with an unexpected exception.",
        ...
        {
            return
                $"CsvDataLoader loaded runtime catalog from resource source '{RuntimeCatalogResourcesPath}' " +
         ...
         * 필요한 CSV 또는 자산을 불러온다.
         */
        private static CsvRuntimeCatalog LoadRuntimeCatalogOrThrow()
        {
         ...
         * 필요한 CSV 또는 자산을 불러온다.
         */
        private static SourceModel LoadSourceModel(CsvRuntimeCatalog sourceCatalog)
        {

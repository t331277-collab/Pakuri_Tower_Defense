...
- 2026-05-18 board maintenance status: `boards/COMBAT/ENEMY_BLACKBOARD.md`, `boards/COMBAT/STATUS_EFFECT_BLACKBOARD.md`, `boards/DATA/DATA_BLACKBOARD.md`, `boards/DATA/GAMEDATA_ASSET_BLACKBOARD.md`, `boards/MON/EVE_MONSTER.md`, `boards/REPORT/REPORT_BLACKBOARD.md`, `boards/RUN/RUN_BLACKBOARD.md`, `boards/UI/RUNSCENE_UI.md`, and `boards/UI/UI_BLACKBOARD.md` were compacted so active files keep only current routing-relevant state; full pre-cleanup snapshots were moved to dated archive files under `boards/ARCHIVE/`, and `MDTREE.md` was rewritten to match the slimmer active-board structure.
